...
/**
 * The {@code postExample_withoutjson} class demonstrates how to make an HTTP POST request
...
public class post {
     ...
     * converts it to a JSON string, and sends it in an HTTP POST request to a specified API endpoint.
     *
